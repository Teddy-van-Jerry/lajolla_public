...
Matrix4x4 translate(const Vector3& delta) {
    return Matrix4x4(Real(1), Real(0), Real(0), delta[0], Real(0), Real(1), Real(0), delta[1], Real(0), Real(0),
                     Real(1), delta[2], Real(0), Real(0), Real(0), Real(1));
}

Matrix4x4 scale(const Vector3& s) {
    return Matrix4x4(s[0], Real(0), Real(0), Real(0), Real(0), s[1], Real(0), Real(0), Real(0), Real(0), s[2], Real(0),
...
Matrix4x4 perspective(Real fov) {
    ...
    return Matrix4x4(cot, Real(0), Real(0), Real(0), Real(0), cot, Real(0), Real(0), Real(0), Real(0), Real(1),
                     Real(-1), Real(0), Real(0), Real(1), Real(0));
}
