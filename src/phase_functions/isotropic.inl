Spectrum eval_op::operator()(const IsotropicPhase&) const { return make_const_spectrum(c_INVFOURPI); }
...
Real pdf_sample_phase_op::operator()(const IsotropicPhase&) const { return c_INVFOURPI; }
