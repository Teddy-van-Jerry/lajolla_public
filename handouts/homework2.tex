...
Store your rendering of the \lstinline{volpath_test1} scene as
\begin{lstlisting}
images/volpath_test1.exr
\end{lstlisting}
...
Store your rendering of the \lstinline{volpath_test3} scene as
\begin{lstlisting}
images/volpath_test3.exr
\end{lstlisting}
...
Store your rendering of the \lstinline{volpath_test4} and \lstinline{volpath_test4_2} scenes as
\begin{lstlisting}
images/volpath_test4.exr
images/volpath_test4_2.exr
\end{lstlisting}
...
Store your rendering of the \lstinline{volpath_test5}, \lstinline{volpath_test5_2}, \lstinline{vol_cbox}, \lstinline{vol_cbox_teapot} scenes as
\begin{lstlisting}
images/volpath_test5.exr
images/volpath_test5_2.exr
images/vol_cbox.exr
images/vol_cbox_teapot.exr
\end{lstlisting}
